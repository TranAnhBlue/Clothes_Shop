...
public class ProductionPlanDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String plidParam = request.getParameter("plid");

        if (plidParam == null || plidParam.isEmpty()) {
            response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Missing or invalid production plan ID");
            return;
        }

        int plid = Integer.parseInt(plidParam);
